...
<head>
    ...
    <title>Join With Nord`s | SignUp</title>
</head>
    ...
    <div class="flex">
        <div class="flex justify-center items-center h-screen w-full">
            <div class="max-w-xl w-full">
                ...
                <div class="">
                    <form class="max-w-sm mx-auto" action="/signup" method="POST">
                        @csrf
                        <div class="mb-5">
                            <label for="name"
                            ...
                            <input name="name" type="text" id="name"
                                ...
                                placeholder="Jhons" autocomplete="off">
                            @error('name')
                        ...
                        <div class="grid gap-5">
                            <button
                                type="submit"class="text-white border py-3 rounded-full hover:bg-gray-950 transition font-bold">Daftar</button>
